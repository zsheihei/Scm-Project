...
use think\Request;
use think\Url;
use app\scm\model\system\SystemGroup as GroupModel;
use app\scm\model\system\SystemGroupData as GroupDataModel;
use app\scm\controller\AuthController;
use app\scm\model\system\SystemAttachment;
/**
 * 数据列表控制器  在组合数据中
